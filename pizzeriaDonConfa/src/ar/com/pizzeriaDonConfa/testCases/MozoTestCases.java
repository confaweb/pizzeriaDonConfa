...
//		PREPARACION
		String nombre="Pedro",apellido="Lopez",nombrePizzeria="donConfa",domicilio="alberdi 2222",eMail="pizzaDC@xml.com",
				instagram="@pDcok",facebook="pDC";
...
//		EJECUCION
		...
		Persona mozo1 =new Empleado(nombre,apellido,dni,legajo,codigoFuncion);
		Pizzeria donConfa= new Pizzeria(nombrePizzeria,cuit,domicilio,telefono,eMail,instagram,
				facebook);
